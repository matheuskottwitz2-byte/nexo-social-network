...
export interface Database {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; username: string; name: string; bio: string; avatar_url: string | null; created_at: string; updated_at: string }
        Insert: { id: string; username: string; name: string; bio?: string; avatar_url?: string | null; created_at?: string; updated_at?: string }
        Update: { username?: string; name?: string; bio?: string; avatar_url?: string | null; updated_at?: string }
        Relationships: []
      }
      posts: {
